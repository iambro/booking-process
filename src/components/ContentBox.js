        ...
        <form className="form">
          ...
          <div className="form-group date">
            <label className="form-date-label">
              <span className="form-date-numeric">13.05</span>
              <span className="form-date-human">Today</span>
            </label>
            <label className="form-date-label">
              <span className="form-date-numeric">14.05</span>
              <span className="form-date-human">Tomorrow</span>
            </label>
            <label className="form-date-label">
              <span className="form-date-numeric">15.05</span>
              <span className="form-date-human">Wednesday</span>
            </label>
            <span className="form-datepicker">
              <input className="form-datepicker-input" type="date" />
          ...
          <div className="form-group time">
            ...
            <input className="form-time-input" type="time" />
          </div>
          <div className="form-group">
